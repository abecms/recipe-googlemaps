...
;(function ($, window, document, undefined) {
	...
	$.extend(Plugin.prototype, {
		...
		listSetup: function (marker, storeStart, page) {
			...
			$('.' + this.settings.locationList + ' ul').append(listHtml).find('li:not(.fadeinit)').hide().addClass('fadeinit').fadeIn();
		},
		...
		processForm: function (e) {
			$('.bh-sl-loc-list ul li').fadeOut();
			this.settings.isEmptyFirst = false;
			$('.bh-sl-loc-list .up, .bh-sl-loc-list .down').fadeIn();
